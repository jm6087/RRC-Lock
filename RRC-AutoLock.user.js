...
(function() {
    ...
    function RRCAutoLockTab()
    {
        ...
        $RRCsection.html([
            ...
            '<b><id="RRCAutoLockLevelValue">RRC lock level <select id="RRCAutoLockLevelOption"></br></b>',
            ...
            '<b><id="ECAutoLockLevelValue">Enforcement camera lock level <select id="ECAutoLockLevelOption"></br></b>',
            //          '<option value="6">1</option>',
            //          '<option value="8">2</option>',
            //          '<option value="10">3</option>',
            '<option value="12">4</option>',
